...
<html>
  <head>
    ...
    <title>My JSP 'goods_updata01.jsp' starting page</title>
  ...
  <body>
    <h3>当前位置&gt;修改商品</h3>
        <form action="GoodsServlet?method=updataGoods01" method="post">
    		...
    		<tr>
    			...
    			<select name="goodstypename">
    				...
    				<c:forEach items="${lists}" var="l">
    					<option  value="${l.goodstypeid}">${l.goodstypename}</option>
    				</c:forEach>
    			</select>
    			</td>
    		</tr>
